...
PROMPT_CONFIGS: Final[dict] = {
    ...
    "Maieutic": {
        "abductive": "./generation/prompts/Maieutic/abductive.prompt.txt",
        "belief": "./generation/prompts/Maieutic/belief.prompt.txt", # we probably only use this.
        "negation": "./generation/prompts/Maieutic/negation.prompt.txt",
        "question": "./generation/prompts/Maieutic/Q.prompt.txt",
    }
}
